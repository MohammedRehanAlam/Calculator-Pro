...
export const DataConverter: React.FC = () => {
  ...
  const dataUnits = [
    { name: 'Bits', symbol: 'b', factor: 8 },
    { name: 'Bytes', symbol: 'B', factor: 1 },
    { name: 'Kilobytes', symbol: 'KB', factor: 0.001 },
    { name: 'Megabytes', symbol: 'MB', factor: 0.000001 },
    { name: 'Gigabytes', symbol: 'GB', factor: 0.000000001 },
    { name: 'Terabytes', symbol: 'TB', factor: 0.000000000001 },
    { name: 'Petabytes', symbol: 'PB', factor: 0.000000000000001 },
  ];

  const convertData = (value: number, fromUnitName: string, toUnitName: string) => {
    const fromFactor = dataUnits.find(unit => unit.name === fromUnitName)?.factor || 1;
    const toFactor = dataUnits.find(unit => unit.name === toUnitName)?.factor || 1;
  ...
  return (
    <View style={styles.container}>
      <View style={styles.screenHeader}>
        <Text style={styles.screenTitle}>Data Converter</Text>
      ...
      <ScrollView style={styles.converterContainer} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.inputSection}>
          <Text style={styles.inputLabel}>Enter Data Value</Text>
          <TextInput
