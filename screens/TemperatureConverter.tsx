...
export const TemperatureConverter: React.FC = () => {
  ...
  const temperatureUnits = [
    { name: 'Celsius', symbol: '°C', formula: 'celsius' },
    { name: 'Fahrenheit', symbol: '°F', formula: 'fahrenheit' },
    { name: 'Kelvin', symbol: 'K', formula: 'kelvin' },
  ];

  const convertTemperature = (value: number, fromUnitName: string, toUnitName: string) => {
    let celsius = 0;
  ...
  return (
    <View style={styles.container}>
      <View style={styles.screenHeader}>
        <Text style={styles.screenTitle}>Temperature Converter</Text>
      ...
      <ScrollView style={styles.converterContainer} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.inputSection}>
          <Text style={styles.inputLabel}>Enter Temperature Value</Text>
          <TextInput
        ...
        <View style={[styles.resultSection, { marginBottom: 16 }]}>
          ...
          <Text style={styles.resultText}>{getResult()} {temperatureUnits.find(u => u.name === toUnit)?.symbol}</Text>
        </View>
      </ScrollView>
    </View>
  );
